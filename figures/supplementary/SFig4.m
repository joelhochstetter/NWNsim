...
DC_Vsweep(preActFolder, 1.8, 1.8, 1, 10);


%% Specify conductances of initial states
numInitStates = 15;
Gmin  = 5.2538e-09; %minimum conductance of initial state to use in simulations
Gmax = 4.0795e-05; %maximum conductance of initial state to use in simulations
...
% leg = legend('Inactive', 'Active', 'location', 'northwest');
