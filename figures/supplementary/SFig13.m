...
load(strcat2({'t2_T80_ACsaw', thisAmp, 'V_f', thisFreq(1), 'Hz_s0.01_r0.01_c0.01_m0.015_b10_p1.mat'}))
f = thisFreq(1);
subplot(1, 3, 1);
...
load(strcat2({'t2_T80_ACsaw', thisAmp, 'V_f', thisFreq(2), 'Hz_s0.01_r0.01_c0.01_m0.015_b10_p1.mat'}))
f = thisFreq(2);
subplot(1, 3, 2);
plot(sim.Stim.TimeAxis(trange)*f, sim.nwV(trange,nds)./max(abs(sim.nwV(trange,nds))))
xlabel('t/T')
...
load(strcat2({'t2_T80_ACsaw', thisAmp, 'V_f', thisFreq(3), 'Hz_s0.01_r0.01_c0.01_m0.015_b10_p1.mat'}))
f = thisFreq(3);
subplot(1, 3, 3);
plot(sim.Stim.TimeAxis(trange)*f, sim.nwV(trange,nds)./max(abs(sim.nwV(trange,nds))))
xlabel('t/T')
